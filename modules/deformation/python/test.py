...
def demo():
    start = time.time()
    objpath = '/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/001_f301_0.obj'
    #VS, FS = loadObj(objpath)
    VS, _, FS = mesh.interact.load_obj_with_colors(objpath)
    objpath = "/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/001_f192_0.obj"
    #VS2, FS2 = loadObj(objpath)
    VS2, _, FS2 = mesh.interact.load_obj_with_colors(objpath)
    target_objpath = '/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/000_f1_0.obj'
