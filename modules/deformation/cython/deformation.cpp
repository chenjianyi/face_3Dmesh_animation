...
static const char __pyx_k_create_by_chenjianyi_create_tim[] = "\ncreate by: chenjianyi\ncreate time: 2020.02.19\n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "deformation",
    __pyx_k_create_by_chenjianyi_create_tim, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("deformation", __pyx_methods, __pyx_k_create_by_chenjianyi_create_tim, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
