...
{   
    /*
    const std::string SAfilename = "/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/001_f301_0.obj";
    const std::string SBfilename1 = "/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/001_f269_0.obj";
    const std::string SBfilename2 = "/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/001_f192_0.obj";
    const std::string SBfilename3 = "/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/001_f14_0.obj";

    const std::string TAfilename = "/mnt/mfs/chenjianyi/GAN/Face3d/face2face/3DDFA/results/000_f1_0.obj";
    ...
    */
    ...
    const std::string SAfilename = "/mnt/mfs/chenjianyi/records/Deepfake/face2face/face_3dmm/000/000_f0000_0.obj";
    const std::string TAfilename = "/mnt/mfs/chenjianyi/records/Deepfake/face2face/face_3dmm/003/003_f0091_0.obj";
    const std::string SBfilelist = "/mnt/mfs/chenjianyi/records/Deepfake/face2face/face_3dmm/000.txt";
    const std::string TBfilelist = "/mnt/mfs/chenjianyi/records/Deepfake/face2face/face_3dmm/003.txt";
    TriangleMesh SA, TA;
    load_obj(SAfilename, SA);
    load_obj(TAfilename, TA);
    const std::string constrainsFile = "./constrains_ind.txt";
