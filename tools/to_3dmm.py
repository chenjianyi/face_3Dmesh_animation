...
if __name__ == '__main__':
    ...
    #parser.add_argument('--out_dir', default='/mnt/mfs/chenjianyi/records/Deepfake/face2face/fce_3dmm/003', type=str)
    ...
    dir3 = "/mnt/mfs/chenjianyi/project/Deepfake/Deep3DFaceReconstruction/input"
    
    path = 'Lark20210310-190550.jpeg'
    demo.predict(path)
    exit()
    ...
    opt.out_dir = "/mnt/mfs/chenjianyi/records/Deepfake/face2face/swapdirect"
    demo = Demo(opt)
